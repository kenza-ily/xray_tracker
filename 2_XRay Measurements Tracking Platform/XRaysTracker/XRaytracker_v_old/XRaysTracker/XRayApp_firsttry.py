...
runfile('Y:/10 - Projects/02-Database managment/XRay Measurements Tracking Plaform/df_saver.py', wdir='Y:/10 - Projects/02-Database managment/XRay Measurements Tracking Plaform')
